...
Until the first stable release, only the latest published release candidate is
supported.
...
storage you do not own or have permission to access.

The implementation threat model and enforced boundaries are documented in
